...
public class GridSystemVisual : MonoBehaviour
{
    ...
    public enum GridVisualType { White, Blue, Red, Yellow, LightRed }
    ...
    private Material GetGridVisualTypeMaterial(GridVisualType gridVisualType)
    {
        ...
        {
            if (material.gridVisualType == gridVisualType) { return material.material; }
        }
